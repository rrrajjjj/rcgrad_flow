...
FLOW_MODEL_PATH = "../rcgrad_flow/models/epoch=90-val_loss=3.2283.ckpt"
...
def main():
    ...
    # get predictions
    if model == "rc_grad":
        rc_grad = RCGrad(checkpoint = checkpoint, gradcam_model=gradcam_model)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-gradcam_model", action = "store", default="vision")
    ...
    gradcam_model = parser.parse_args().gradcam_model
